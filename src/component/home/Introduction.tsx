...
function Introduction() {
  const introductionImgRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (!scrollPosition) {
        const imgSection = introductionImgRef.current;
        if (imgSection) {
          const imgSectionRect = imgSection.getBoundingClientRect();
          if (imgSectionRect.bottom <= window.innerHeight) {
  ...
  return (
    <div >
      <div className="introduction">
        <div className="introduction-img" ref={introductionImgRef}>
          <CCarousel
            // interval={}
            controls >
            <CCarouselItem>
            ...
            <CCarouselItem>
              <div className="introduction-img_item">
                <img src="https://heliosjewels.vn/cdn/shop/files/nhan-bac-s925-adbaddon-helios-silver-original_3_720x.jpg?v=1710241827" alt="" />
                <img src="https://heliosjewels.vn/cdn/shop/files/nhan-bac-s925-adbaddon-helios-silver-original_4_720x.jpg?v=1710296827" alt="" />
              </div>
            </CCarouselItem>
            <CCarouselItem>
              <div className="introduction-img_item">
                <img src="https://heliosjewels.vn/cdn/shop/files/nhan-bac-s925-adbaddon-helios-silver-original_5_720x.jpg?v=1710296827" alt="" />
                <img src="https://heliosjewels.vn/cdn/shop/files/nhan-bac-s925-adbaddon-helios-silver-original_6_720x.jpg?v=1710296827" alt="" />
              </div>
            </CCarouselItem>
            <CCarouselItem>
              <div className="introduction-img_item">
                <img src="https://heliosjewels.vn/cdn/shop/files/nhan-bac-s925-adbaddon-helios-silver-original_7_720x.jpg?v=1710296828" alt="" />
                <video controls>
        ...
        <div className="introduction-content"  ref={introductionContentRef}
          style={{ overflowY: scrollPosition ? "auto" : "hidden" }}>
          <h1>
